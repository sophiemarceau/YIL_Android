...
//            Log.e(TAG,"longitude－－－－－－>"+longtitude);
...
//        Log.e("map", "showMapWithLocationClient");
...
//                Log.e("map", "cancel retrieve location");
                finish();
            }
        });
...
//                Log.e("map", "MyLocationListenner--------location----------->"+location);
                if (location == null) {
                    return;
                }
//                Log.e("map", "On location change received:" + location);
...
//                Log.e("map", "addr:" + location.getAddrStr());
                ...
                MapStatusUpdate u = MapStatusUpdateFactory.newLatLngZoom(convertLatLng, 17.0f);
                mBaiduMap.animateMapStatus(u);
//                Log.e("map", "animateMapStatus");
        }

        public void onReceivePoi(BDLocation poiLocation) {
//            Log.e("map", "onReceivePoi");
            if (poiLocation == null) {
                return;
            }
        }
