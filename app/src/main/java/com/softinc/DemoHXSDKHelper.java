 ...
 * limitations under the License.屈小波 测试svn
 */
package com.softinc;
...
import com.softinc.applib.model.HXNotifier;
import com.softinc.applib.model.HXSDKModel;
import com.softinc.applib.model.HXNotifier.HXNotificationInfoProvider;
import com.easemob.chat.CmdMessageBody;
import com.easemob.chat.EMChatManager;
import com.easemob.chat.EMMessage;
import com.easemob.chat.EMMessage.ChatType;
import com.easemob.chat.EMMessage.Type;
import com.softinc.receiver.CallReceiver;
        ...
        return new HXNotificationInfoProvider() {
            ...
            public Intent getLaunchIntent(EMMessage message) {
                ...
                if (chatType == ChatType.Chat) { // 单聊信息
                    List<User> returnList =DemoHXSDKHelper.getInstance().getGetcontactList();
                    for(User temp :returnList){
                        if (temp.getUsername().equals(message.getFrom())){

//                            intent.putExtra("chatType", ChatActivity.CHATTYPE_SINGLE);

                            Bundle myBundelForName = new Bundle();
                            myBundelForName.putString("userId", message.getFrom());
                            myBundelForName.putInt("chatType", ChatActivity.CHATTYPE_SINGLE);
                            myBundelForName.putString("nickname", (temp.getNick()));
